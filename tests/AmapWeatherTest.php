...
namespace Shallowr\AmapWeather\Tests;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Psr7\Response;
use Shallowr\AmapWeather\Exception\InvalidArgumentException;
use Shallowr\AmapWeather\AmapWeather;
use PHPUnit\Framework\TestCase;

class AmapWeatherTest extends TestCase
{
    // 检查 $type 参数
    public function testGetWeatherWithInvalidType()
    {
        $w = new AmapWeather('mock-key');
    ...
    public function testGetWeather()
    {
        ...
        $w = \Mockery::mock(AmapWeather::class, ['mock-key'])->makePartial();
